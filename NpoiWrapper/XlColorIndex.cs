...
namespace Developers.NpoiWrapper
{
    ...
    /// </summary>
    internal static class XlColorIndexParser
    {
        /// <summary>
        ...
        public static bool Try(object TryValue, out int XlValue)
        {
            bool RetVal = false;
    ...
    /// XlPatternとFillPatternの相互変換
    /// </summary>
    internal static class PoiColorIndexParser
    {
        /// <summary>
        ...
        /// <returns>確認結果</returns>
        public static bool Try(object TryValue, out short PoiValue)
        {
            bool RetVal = false;
